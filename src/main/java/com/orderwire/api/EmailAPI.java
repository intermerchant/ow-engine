...
public class EmailAPI {
    ...
    public EmailAPI(String threadName){
        owThreadName = threadName;
    }

    public boolean sendHtmlEmail(HashMap emailDetailMap) {
        ...
        try {
            ...
            procStatus = false;
            UtilLogger.setDbStatus(owThreadName, "EmailAPI", "HtmlEmailSender", "", "Address Exception", ae.getMessage());
        } catch (MessagingException me) {
            procStatus = false;
            UtilLogger.setDbStatus(owThreadName, "EmailAPI", "HtmlEmailSender", "", "Messaging Exception", me.getMessage());
        } catch (Exception exce){
            procStatus = false;
            UtilLogger.setDbStatus(owThreadName, "EmailAPI", "HtmlEmailSender", "", "Exception", exce.getMessage());
        }
